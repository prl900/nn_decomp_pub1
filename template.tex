...
To carry out the experiments in this work we used Sentinel 2 data from the Digital Earth Australia dataset \citep{dhu2017digital}. We considered an area of 7000 km^2 around the Australian Capital Territory for the years 2018 and 2019. Spectrally, we used seven bands, three visible channels, two near infra-red and two short wave infrared, corresponding to bands (2, 3, 4, 8, 8a, 11, 12) in the original dataset.

The data used the 10 metres resoltion and the rest of the bands where sampled to this resThe data was divided in tiles of 4 squared kilometers and the whole temporal extent for applying the decomposition methodology indidually. The whole region region was  
