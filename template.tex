...
The data was then split using regular tiles of 4 squared kilometers each, comprising the whole temporal extent. Figure \ref{dataset} contains a representation of the region and extent of each tile within a 16 by 23 grid. This continuous region contains a fair mix of full and partial tiles due to boundaries in the original Sentinel 2 scenes. This should give a good idea of the algorithm's general performance compared to hand picked tiles over sparse areas.
