...
As we pointed out, the principal components in the multispectral decomposition are shared between the bands. Features that are common to several spectral bands can be represented through the same principal component resulting in more efficient representation than in per band decompositions. Interpreting the functionality convolution kernel is not entirely obvious, but its functionality in this  to expand the number of  
