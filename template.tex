...
The horizontal dashed black line in the plot represents the MSE value generated by the single band decomposition using 6 principal components. In this method we performed one decomposition per spectral band (7 bands) using the basic NN methodology and averaged the individual MSE scores. Effectively, the number of components in this case is 7 times larger resulting in 42 principal components. An equivalent level of error is achieved at 16 principal components in the case of the basic NN methodology and at 12 for its convolutional variant. 

For comparing the compression ratios achieved with each methodology, we added the sizes of all the elements in the neural networks. Table \ref{components_error} describes the elements and the total size for each methodology for 12 principal components and an image stack comprising 138 images per band.

\begin{table}[]
\begin{tabular}{lcccc|c}
\hline
Decomposition methodology               & \multicolumn{1}{l}{Number of networks} & \multicolumn{1}{l}{Size of coefficients matrix} & \multicolumn{1}{l}{Size of PCs matrix} & \multicolumn{1}{l|}{Size of convolution kernel} & \multicolumn{1}{l}{Total size in MB {[}float32{]}} \\ \hline
Raw data (ref)                          & -                                      & -                                               & -                                      & -                                               & 147.40                                             \\
Single band basic NN (6 PCs)            & 7                                      & 138x6                                           & 400x400x6                              & -                                               & 6.41                                               \\
Multispectral basic NN (16 PCs)         & 1                                      & 7x138x16                                        & 400x400x16                             & -                                               & 2.46                                               \\
Multispectral convolutional NN (12 PCs) & 1                                      & 7x138x24                                        & 404x404x12                             & 5x5x12x24                                       & 1.90                                               \\ \hline
\end{tabular}
\end{table}

On average, the multispectral decompostion is around 2.6 times more efficient than the single band decompostion and this ratio increases to 3.5 in the case of introducing the convolution operation in the network. 




and the reconstruction error varies between bands. Certain types of soils, vegetation or moisture conditions are represented very differently by spectral bands and these unique features are not well represented by the principal components. To assess the quality of the multispectral decomposition and the variability of the reconstruction error for the different bands, we compare the MSE of the reconstructed images for the multispectral and single band decompositions using the Sentinel-2 dataset. 
