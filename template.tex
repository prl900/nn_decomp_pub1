...
The data was then split using regular tiles of 4 squared kilometers each one comprising the whole temporal extent. Figure \ref{dataset} contains a representation of the region and extent of each tile.
